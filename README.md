# Python Faker: Datos aleatorios, de prueba y para inserciones masivas con Python

Aprende a generar datos (nombres, direcciones, emails, etc.) de prueba, aleatorios y pensados para realizar inserciones masivas (en una tabla de una base de datos por ejemplo) y utilizarlos en una REST API o para comprobar el rendimiento de una consulta SQL.
